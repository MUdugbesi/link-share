    ...
    return (
        <div className="w-[1440px] mx-auto">
            <div className="flex flex-col md:grid md:grid-cols-1 lg:grid-cols-[560px_808px] gap-6 md:gap-8 h-auto justify-evenly p-4 lg:p-0">
                ...
                <div className="bg-bg-primary rounded-2xl flex flex-col gap-2 p-4 lg:p-6 max-sm:w-[375px] h-auto">
                    <div className="flex flex-col gap-4 lg:gap-8 max-sm:w-[311px] mx-auto w-full">
                        ...
                        <div className={`w-full ${links.length > 0 ? 'min-h-[200px] ' : 'h-[300px] md:h-[400px] lg:h-[539px]'}`}>
                            {!links.length ? (
                                <div className="bg-bg-primary-2 md:w-[601px] h-full mx-auto mt-4 flex flex-col items-center justify-center text-center">
                                    <Image src='/drag.svg' alt="drag and drop link" width={249.53} height={160} className="mb-4 md:mb-8 max-sm:w-[124.77px] max-sm:h-[70px]" />
                    ...
                    <div className="border-t border-bg-primary-3 w-full flex justify-end items-center pt-4 mt-4">
                        <Button
                            className='bg-bg-btn-2 w-[311px] max-sm:mx-auto md:w-24 h-12 text-bg-primary hover:bg-bg-btn'
