...
const SignupForm = () => {
    ...
    return (
        <>
            ...
            <div className="flex flex-col w-[311px] md:w-[476px] h-[709px] mx-auto gap-[51px] justify-between mt-[103px] md:mt-[206px] max-sm:mb-[80px] ">
                ...
                <div className="flex flex-col h-[618px] w-full mx-auto rounded-[12px] bg-bg-primary justify-evenly">
                    <div className="h-[80px] w-[396px] mx-auto gap-[8px] flex flex-col">
                        <h2 className="md:heading_M heading_M_">Create Account</h2>
                        <span className="body_M">Let’s get you started sharing your links!</span>
                    </div>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-[24px] mx-auto md:w-[396px] w-[311px] md:h-[418px] h-auto">
                            <FormField
                                control={form.control}
                                name="email"
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="body_S">Email Address</FormLabel>
                                        <FormControl>
                                            <div className="flex relative">
                                                <Image src={EmailIcon} alt="email" className="absolute top-[20px] left-[18px]" width={13} height={10} />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormMessage className="body_S pt-[10px]" />
                                    </FormItem>
                                )}
                            />
                            <Button type="submit" className="bg-bg-btn h-[46px] text-[white] heading_S">Register</Button>
                            <span className="body_M text-center w-[70%] mx-auto">Already have an account? <Link href='/auth/login' className="text-bg-btn">Login</Link></span>
                        </form>
                    </Form>
                </div>
            </div>
